    ...
    return (
        <div className={`max-w-md`}>
            <div className={`text-lg text-grey-darker leading-normal`}>
                <h1>Open Projects</h1>
                <p>Over the past few years, I have been employed to work on private projects and I was frustrated that I could not show my ability to the public.</p>
                <p className={`mb-12`}>Then, I decided to create open source projects to show what I can do, share what I have learnt and plan what I should do.</p>
                ...
                <div className={`text-grey-darkest text-base leading-normal mb-6 -mt-2`}>
